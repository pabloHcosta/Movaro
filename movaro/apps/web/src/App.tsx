...
const copy = {
  es: {
    ...
    founder: ['CREADO ENTRE BRASIL Y ARGENTINA', 'Una herramienta nacida de una experiencia real.', 'Soy Pablo Costa, brasileño, vivo en Argentina y conozco de cerca las dudas y decisiones que aparecen al mudarse entre los dos países. Esa experiencia me mostró lo difícil que es transformar información dispersa en acciones concretas.', 'Mudavi es un proyecto nuevo que estoy construyendo para ayudar a quienes planean mudarse de Argentina a Brasil a comparar posibilidades, organizar los preparativos y avanzar con un próximo paso más claro.', 'Fundador de Mudavi'],
  ...
  pt: {
    ...
    founder: ['CRIADO ENTRE BRASIL E ARGENTINA', 'Uma ferramenta que nasceu de uma experiência real.', 'Sou Pablo Costa, brasileiro, vivo na Argentina e conheço de perto as dúvidas e decisões de uma mudança entre os dois países. Essa experiência me mostrou como é difícil transformar informações dispersas em ações concretas.', 'O Mudavi é um projeto novo que estou construindo para ajudar quem planeja mudar da Argentina para o Brasil a comparar possibilidades, organizar os preparativos e avançar com um próximo passo mais claro.', 'Fundador do Mudavi'],
  ...
  en: {
    ...
    founder: ['CREATED BETWEEN BRAZIL AND ARGENTINA', 'A tool born from real experience.', 'I am Pablo Costa, a Brazilian living in Argentina, and I know firsthand the questions and decisions that come with moving between the two countries. That experience showed me how difficult it is to turn scattered information into concrete action.', 'Mudavi is a new project I am building to help people planning a move from Argentina to Brazil compare possibilities, organize their preparation, and move forward with a clearer next step.', 'Founder of Mudavi'],
