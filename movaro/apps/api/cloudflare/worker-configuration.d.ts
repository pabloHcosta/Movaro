/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.container.jsonc cloudflare/worker-configuration.d.ts` (hash: 0b07be438d32f673c1a7a630a3e7738b)
// Runtime types generated with workerd@1.20260911.1 2026-09-13 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "https://staging.mudavi.app" | "https://mudavi.app,https://www.mudavi.app";
	API_CONTAINER: DurableObjectNamespace<import("./worker").MudaviApiContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "MudaviApiContainer";
	}
	interface StagingEnv {
		ALLOWED_ORIGINS: "https://staging.mudavi.app";
		API_CONTAINER: DurableObjectNamespace<import("./worker").MudaviApiContainer>;
	}
