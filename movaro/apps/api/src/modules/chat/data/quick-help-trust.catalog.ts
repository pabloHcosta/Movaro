...
export const QUICK_HELP_ENTRIES: QuickHelpEntryDefinition[] = [
  ...
  },
  {
    ...
    claims: [
      ...
      {
        id: 'housing-guarantee-alternatives',
        text: {
          pt: 'Sem fiador, você pode negociar outra modalidade prevista na Lei do Inquilinato, como caução ou seguro-fiança; o contrato deve usar somente uma modalidade de garantia.',
          es: 'Sin garante, podés negociar otra modalidad prevista por la Ley de Alquileres de Brasil, como depósito o seguro de caución; el contrato debe usar una sola modalidad de garantía.',
          en: 'Without a guarantor, you can negotiate another option permitted by Brazil’s Tenancy Law, such as a deposit or rental-guarantee insurance; the agreement must use only one guarantee type.',
        },
        evidenceIds: ['tenancy-law'],
        status: 'verified',
      },
  ...
  },
  {
    ...
    claims: [
      ...
      {
        id: 'work-search-through-sine',
        text: {
          pt: 'O Sine é o canal público de intermediação de mão de obra: você pode cadastrar o perfil e consultar vagas pelo Portal Emprega Brasil, pelo aplicativo Carteira de Trabalho Digital ou em um posto da rede.',
          es: 'El Sine es el canal público de intermediación laboral: podés registrar tu perfil y consultar vacantes en el Portal Emprega Brasil, en la aplicación Carteira de Trabalho Digital o en una oficina de la red.',
          en: 'Sine is the public employment-matching service: you can register your profile and search vacancies through Portal Emprega Brasil, the Digital Work Card app, or a Sine office.',
        },
        evidenceIds: ['sine-job-search'],
        status: 'verified',
      },
    ],
    evidence: [
      ...
      },
      {
        ...
        publisher: 'Ministério do Trabalho e Emprego',
        title: {
          pt: 'Buscar emprego no Sine',
          es: 'Buscar empleo en Sine',
          en: 'Search for work through Sine',
        },
        ...
        jurisdiction: 'BR-federal-local-operation',
        scope: {
          pt: 'Canais oficiais para cadastro de perfil e consulta de vagas.',
          es: 'Canales oficiales para registrar el perfil y consultar vacantes.',
          en: 'Official channels for profile registration and vacancy search.',
        },
      },
    ],
    caveat: {
    ...
    evidence: [
      {
        ...
        url: 'https://www.gov.br/saude/pt-br/composicao/saps/equidade-em-saude/migrantes-refugiadas-e-apatridas',
        checkedAt: '2026-08-24',
        validUntil: '2026-11-18',
        jurisdiction: 'BR-federal-local-operation',
        scope: {
  ...
  },
  {
    ...
    claims: [
      ...
      {
        id: 'housing-rental-fraud-warning-signs',
        text: {
          pt: 'Preço muito abaixo do mercado, pressão para pagar antes da visita, recusa em mostrar o imóvel e identidade do anunciante que não pode ser confirmada são sinais de alerta. Verifique anúncio, imóvel e responsável antes de transferir qualquer valor.',
          es: 'Un precio muy inferior al mercado, presión para pagar antes de la visita, negativa a mostrar el inmueble e identidad del anunciante que no puede confirmarse son señales de alerta. Verificá el anuncio, el inmueble y al responsable antes de transferir dinero.',
          en: 'A price far below the market, pressure to pay before a viewing, refusal to show the property, and an advertiser whose identity cannot be confirmed are warning signs. Verify the listing, property, and responsible person before transferring money.',
        },
        evidenceIds: ['creci-rental-fraud'],
        status: 'conditional',
      },
    ],
    evidence: [
      ...
      {
        id: 'creci-rental-fraud',
        publisher: 'CRECI-MS',
        title: {
          pt: 'Golpe do falso aluguel',
          es: 'Estafa del alquiler falso',
          en: 'Fake rental scam',
        },
        url: 'https://www.crecims.gov.br/noticia.php?id=1591',
        checkedAt: '2026-08-24',
        validUntil: '2027-02-24',
        jurisdiction: 'BR-consumer-real-estate-guidance',
        scope: {
          pt: 'Sinais de alerta e prevenção antes de pagar por um imóvel anunciado.',
          es: 'Señales de alerta y prevención antes de pagar por un inmueble anunciado.',
          en: 'Warning signs and prevention before paying for an advertised property.',
        },
      },
    ],
    caveat: {
  ...
  },
  {
    ...
    claims: [
      ...
      {
        id: 'education-admission-follows-selection-route',
        text: {
          pt: 'O ingresso depende da rota oferecida pela instituição. No Sisu, a seleção usa o Enem e cada instituição define vagas, cursos e modalidades; outras instituições podem usar vestibular ou processo próprio.',
          es: 'El ingreso depende de la vía ofrecida por la institución. En Sisu, la selección usa el Enem y cada institución define vacantes, carreras y modalidades; otras instituciones pueden usar examen o proceso propio.',
          en: 'Admission depends on the route offered by the institution. Sisu uses Enem results and each institution defines its vacancies, courses, and categories; other institutions may use an entrance exam or their own process.',
        },
        evidenceIds: ['sisu-admission-service'],
        status: 'conditional',
      },
    ],
    evidence: [
      ...
      {
        id: 'sisu-admission-service',
        publisher: 'Ministério da Educação',
        title: {
          pt: 'Inscrever-se no Sisu',
          es: 'Inscribirse en Sisu',
          en: 'Apply through Sisu',
        },
        url: 'https://www.gov.br/pt-br/servicos/inscrever-se-no-sisu-sistema-de-selecao-unificada?id=13350&origem=servico',
        checkedAt: '2026-08-24',
        validUntil: '2027-03-01',
        jurisdiction: 'BR-federal-institution-operation',
        scope: {
          pt: 'Critérios nacionais do Sisu e autonomia das instituições participantes.',
          es: 'Criterios nacionales de Sisu y autonomía de las instituciones participantes.',
          en: 'National Sisu criteria and participating institutions’ choices.',
        },
      },
    ],
    caveat: {
  ...
  {
    id: 'costs-personal-budget',
    topic: 'costs',
    contentVersion: CONTENT_VERSION,
    editorialOwner: EDITORIAL_OWNER,
    reviewedAt: '2026-08-24',
    expiresAt: '2027-02-24',
    jurisdiction: 'BR-personal-finance-guidance',
    riskLevel: 'financial',
    answerMode: 'direct',
    coverageStatus: 'conditional',
    claims: [
      {
        id: 'costs-budget-from-recorded-expenses',
        text: {
          pt: 'Calcule o custo mensal registrando moradia, alimentação, transporte, saúde, comunicação e outras despesas recorrentes; mantenha separados os gastos únicos da mudança para não distorcer o mês seguinte.',
          es: 'Calculá el costo mensual registrando vivienda, alimentación, transporte, salud, comunicación y otros gastos recurrentes; separá los gastos únicos de la mudanza para no distorsionar el mes siguiente.',
          en: 'Calculate monthly cost by recording housing, food, transport, health, communications, and other recurring expenses; keep one-off moving costs separate so they do not distort the following month.',
        },
        evidenceIds: ['bcb-personal-budget'],
        status: 'conditional',
      },
      {
        id: 'costs-reserve-by-time-horizon',
        text: {
          pt: 'Para comparar 30, 60 e 90 dias, multiplique apenas o total mensal recorrente por um, dois ou três e depois some instalação, viagem e uma margem para imprevistos. O resultado depende da cidade, família, moradia e renda; não há um valor único seguro para todas as pessoas.',
          es: 'Para comparar 30, 60 y 90 días, multiplicá solamente el total mensual recurrente por uno, dos o tres y después sumá instalación, viaje y un margen para imprevistos. El resultado depende de la ciudad, familia, vivienda e ingresos; no existe un valor único seguro para todas las personas.',
          en: 'To compare 30, 60, and 90 days, multiply recurring monthly costs by one, two, or three, then add setup, travel, and a contingency margin. The result depends on city, household, housing, and income; there is no single safe amount for everyone.',
        },
        evidenceIds: ['bcb-personal-budget'],
        status: 'conditional',
      },
    ...
    evidence: [
      {
        id: 'bcb-personal-budget',
        publisher: 'Banco Central do Brasil',
        title: {
          pt: 'O que é um orçamento pessoal?',
          es: '¿Qué es un presupuesto personal?',
          en: 'What is a personal budget?',
        },
        url: 'https://www.bcb.gov.br/meubc/faqs/p/o-que-e-um-orcamento-pessoal',
        checkedAt: '2026-08-24',
        validUntil: '2027-02-24',
        jurisdiction: 'BR-financial-education',
        scope: {
          pt: 'Método de planejamento a partir de receitas e despesas registradas.',
          es: 'Método de planificación a partir de ingresos y gastos registrados.',
          en: 'Planning method based on recorded income and expenses.',
        },
      },
    ],
    caveat: {
      pt: 'A Central não conhece seus preços reais nem substitui uma cotação local; revise o orçamento sempre que cidade, aluguel ou composição familiar mudar.',
      es: 'La Central no conoce tus precios reales ni reemplaza una cotización local; revisá el presupuesto cuando cambien la ciudad, el alquiler o la familia.',
      en: 'Help does not know your actual prices or replace local quotes; review the budget whenever the city, rent, or household changes.',
    },
  },
  {
    id: 'documents-identifiers-and-starting-order',
    topic: 'documents',
    contentVersion: CONTENT_VERSION,
    editorialOwner: EDITORIAL_OWNER,
    reviewedAt: '2026-08-24',
    expiresAt: '2026-11-24',
    jurisdiction: 'BR-federal-banking-operation',
    riskLevel: 'legal',
    answerMode: 'direct',
    coverageStatus: 'conditional',
    claims: [
      {
        id: 'documents-cpf-protocol-crnm-have-different-functions',
        text: {
          pt: 'CPF é o cadastro fiscal administrado pela Receita Federal; o protocolo comprova ou permite acompanhar um requerimento específico; e a CRNM é o documento físico de identificação da pessoa imigrante já registrada, contendo o número RNM. Um não substitui automaticamente o outro.',
          es: 'El CPF es el registro fiscal administrado por la Receita Federal; el protocolo acredita o permite seguir una solicitud específica; y la CRNM es el documento físico de identidad de la persona migrante registrada, que contiene el número RNM. Uno no sustituye automáticamente al otro.',
          en: 'CPF is the tax registration administered by the Federal Revenue; a protocol documents or enables tracking of a specific application; and CRNM is the physical identity document for a registered immigrant and contains the RNM number. They do not automatically replace one another.',
        },
        evidenceIds: ['documents-receita-cpf', 'documents-pf-rnm-crnm'],
        status: 'verified',
      },
      {
        id: 'documents-start-with-legal-route-not-bank-requirement',
        text: {
          pt: 'Comece identificando a rota de residência e solicitando o CPF pelos serviços oficiais; guarde cada protocolo e comprovante. Depois peça ao banco a lista escrita de documentos aceita para o seu perfil — endereço, CPF, protocolo e CRNM têm funções diferentes e a instituição pode exigir combinações distintas.',
          es: 'Empezá identificando la vía de residencia y solicitando el CPF en los servicios oficiales; guardá cada protocolo y comprobante. Después pedí al banco la lista escrita de documentos aceptada para tu perfil: domicilio, CPF, protocolo y CRNM cumplen funciones distintas y la institución puede exigir combinaciones diferentes.',
          en: 'Start by identifying the residence route and applying for CPF through the official services; keep every protocol and receipt. Then ask the bank for its written document list for your profile—address, CPF, protocol, and CRNM serve different functions and the institution may require different combinations.',
        },
        evidenceIds: [
          'documents-receita-cpf',
          'documents-pf-residence',
          'documents-bcb-migrants',
        ],
        status: 'conditional',
      },
    ],
    evidence: [
      {
        ...
        jurisdiction: 'BR-federal',
        scope: {
          pt: 'Função e inscrição no CPF.',
          es: 'Función e inscripción en el CPF.',
          en: 'Purpose of and registration for CPF.',
        },
      },
      {
        id: 'documents-pf-rnm-crnm',
        publisher: 'Polícia Federal',
        title: {
          pt: 'Diferença entre RNM e CRNM',
          es: 'Diferencia entre RNM y CRNM',
          en: 'Difference between RNM and CRNM',
        },
        url: 'https://www.gov.br/pf/pt-br/assuntos/imigracao/organizar/duvidas-frequentes2/qual-a-diferenca-de-crnm-e-rnm',
        checkedAt: '2026-08-24',
        validUntil: '2026-11-24',
        jurisdiction: 'BR-federal-migration',
        scope: {
          pt: 'Definição oficial do registro RNM e da carteira CRNM.',
          es: 'Definición oficial del registro RNM y de la tarjeta CRNM.',
          en: 'Official definitions of RNM registration and the CRNM card.',
        },
      },
      {
        id: 'documents-pf-residence',
        publisher: 'Polícia Federal',
        title: {
          pt: 'Autorização de residência',
          es: 'Autorización de residencia',
        ...
        jurisdiction: 'BR-federal-migration',
        scope: {
          pt: 'Rotas oficiais de autorização de residência.',
          es: 'Vías oficiales de autorización de residencia.',
          en: 'Official residence authorization routes.',
        },
      },
      {
        id: 'documents-bcb-migrants',
        publisher: 'Banco Central do Brasil',
        title: {
          pt: 'Informações financeiras para migrantes e refugiados',
          es: 'Información financiera para migrantes y refugiados',
        ...
        url: 'https://aprendervalor.bcb.gov.br/content/cidadaniafinanceira/documentos_cidadania/Cartilha_Migrantes_Refugiados/cartilha_BC_PORTUGUES.pdf',
        checkedAt: '2026-08-24',
        validUntil: '2027-02-24',
        jurisdiction: 'BR-financial-system-guidance',
        scope: {
          pt: 'Documentos e critérios operacionais para acesso a serviços financeiros.',
          es: 'Documentos y criterios operativos para acceder a servicios financieros.',
          en: 'Documents and operational criteria for access to financial services.',
        },
      },
    ],
    caveat: {
      pt: 'A ordem exata pode mudar conforme a base migratória e a política cadastral da instituição; não apresente um protocolo como se fosse a CRNM física.',
      es: 'El orden exacto puede cambiar según la base migratoria y la política de la institución; no presentes un protocolo como si fuera la CRNM física.',
      en: 'The exact order can vary by migration basis and the institution’s onboarding policy; do not present a protocol as if it were the physical CRNM.',
    },
  },
  {
    id: 'flights-purchase-checklist',
    topic: 'flights',
    contentVersion: CONTENT_VERSION,
    editorialOwner: EDITORIAL_OWNER,
    reviewedAt: '2026-08-24',
    expiresAt: '2027-02-24',
    jurisdiction: 'BR-civil-aviation-cross-border',
    riskLevel: 'medium',
    answerMode: 'direct',
    coverageStatus: 'conditional',
    claims: [
      {
        id: 'flights-check-before-purchase',
        text: {
          pt: 'Antes de pagar, confira nome do passageiro, datas e aeroportos, empresa que opera cada trecho, preço total, bagagem incluída, regras de alteração e reembolso e requisitos de embarque. Valide separadamente o documento de entrada no Brasil para a finalidade da viagem.',
          es: 'Antes de pagar, revisá nombre del pasajero, fechas y aeropuertos, empresa que opera cada tramo, precio total, equipaje incluido, reglas de cambio y reembolso y requisitos de embarque. Validá por separado el documento de ingreso a Brasil según la finalidad del viaje.',
          en: 'Before paying, check the passenger name, dates and airports, operating carrier for each segment, total price, included baggage, change and refund rules, and boarding requirements. Separately validate the document required to enter Brazil for the purpose of travel.',
        },
        evidenceIds: ['anac-passenger-guidance', 'pf-mercosur-flight-entry'],
        status: 'conditional',
      },
    ],
    evidence: [
      {
        id: 'anac-passenger-guidance',
        publisher: 'Agência Nacional de Aviação Civil',
        title: {
          pt: 'Orientações para passageiros',
          es: 'Orientaciones para pasajeros',
          en: 'Passenger guidance',
        },
        url: 'https://www.gov.br/anac/pt-br/assuntos/passageiros/passageiros',
        checkedAt: '2026-08-24',
        validUntil: '2027-02-24',
        jurisdiction: 'BR-civil-aviation',
        scope: {
          pt: 'Compra, documentos, bagagem, alterações e reembolso de passagens.',
          es: 'Compra, documentos, equipaje, cambios y reembolso de pasajes.',
          en: 'Ticket purchase, documents, baggage, changes, and refunds.',
        },
      },
      {
        id: 'pf-mercosur-flight-entry',
        publisher: 'Polícia Federal',
        title: {
          pt: 'Documento de viagem no Mercosul',
          es: 'Documento de viaje en el Mercosur',
        ...
        jurisdiction: 'BR-federal-Mercosur',
        scope: {
          pt: 'Documento de viagem conforme a finalidade de entrada.',
          es: 'Documento de viaje según la finalidad de ingreso.',
          en: 'Travel document according to the purpose of entry.',
        },
      },
    ],
    caveat: {
      pt: 'Preço e disponibilidade mudam em tempo real; a Central não vende nem reserva voos.',
      es: 'El precio y la disponibilidad cambian en tiempo real; la Central no vende ni reserva vuelos.',
      en: 'Price and availability change in real time; Help does not sell or reserve flights.',
    },
  },
];
