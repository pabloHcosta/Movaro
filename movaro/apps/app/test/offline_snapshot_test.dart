...
void main() {
  ...
  test('bundled city snapshot parses through CityModel (offline-first)', () async {
  ...
  test('asset fallback routes catalog, single city, search and unmapped paths', () async {
    ...
    final weather = await fallback.resolve('/api/v1/cities/chapeco-sc/weather');
