...
The Mudavi symbol is a continuous route ribbon: it starts open and bright,
...
- `mudavi_app_icon.svg`: full-bleed master for the default iOS and legacy
  Android icon. Never add rounded corners or transparency to this file.
- `mudavi_app_icon_foreground.svg`: transparent adaptive-icon foreground.
- `mudavi_app_icon_macos.svg`: rounded, transparent-canvas master for macOS.
- `mudavi_mark_light.svg`: full-color symbol for dark surfaces.
