  ...
  static List<CityFeedItem> _all(String locale) => [
    ...
    CityFeedItem(
      ...
      body: _t(
        ...
        en: 'Individual Microentrepreneur (MEI): it can usually be opened in about 10 minutes on Gov.br, bill up to R\$81,000/year, and pay ~R\$70/month flat tax. It may be useful for freelancers, consultants, and those receiving from Argentina. A CPF is generally required.',
      ),
      stages: const [UserJourneyStage.planner, UserJourneyStage.executor],
    ),
    ...
    CityFeedItem(
      ...
      body: _t(
        ...
        en: 'Wise or Payoneer receive ARS/USD and convert to BRL at fair rates. MEI issues invoices in BRL for Argentine clients. Income declaration may apply in both countries, so confirming details with a local accountant is usually safer.',
      ),
      stages: const [UserJourneyStage.planner, UserJourneyStage.executor],
    ),
