  ...
  static List<GuideActionItem> build(
    ...
    final items = <GuideActionItem>[
      ...
      GuideActionItem(
        ...
        steps: _list(
          ...
          pt: [
            ...
            'Registre a faixa anunciada e confirme se o valor é bruto ou líquido, além de benefícios e descontos.',
          ...
          es: [
            ...
            'Registrá el rango anunciado y confirmá si el valor es bruto o neto, además de beneficios y descuentos.',
          ...
          en: [
            ...
            'Record the advertised range and confirm whether it is gross or net, including benefits and deductions.',
        ...
        doneCriteria: _t(
          locale,
          pt: 'Você registrou sua área, idioma, experiência, exigência profissional, evidência de vagas e a relação entre renda esperada e custo essencial.',
          es: 'Registraste tu área, idioma, experiencia, exigencia profesional, evidencia de vacantes y la relación entre ingreso esperado y costo esencial.',
          en: 'You recorded your field, language, experience, professional requirements, opening evidence, and the relationship between expected income and essential costs.',
        ),
        tips: _list(
          locale,
          pt: [
            _marketExchangeTip(locale, exchangeRates: exchangeRates),
            'Em vagas CLT, confirme salário bruto, descontos, benefícios, jornada e local de trabalho antes de estimar o líquido.',
            'Mantenha currículo e perfil em português quando a vaga exigir comunicação local.',
            'Para renda remota ou cliente estrangeiro, confirme atividade permitida, tributação e residência fiscal antes de escolher MEI ou outra estrutura.',
          ],
          es: [
            _marketExchangeTip(locale, exchangeRates: exchangeRates),
            'En puestos CLT, confirmá salario bruto, descuentos, beneficios, jornada y lugar de trabajo antes de estimar el neto.',
            'Mantené CV y perfil en portugués cuando la vacante exija comunicación local.',
            'Para ingreso remoto o clientes extranjeros, confirmá actividad permitida, impuestos y residencia fiscal antes de elegir MEI u otra estructura.',
          ],
          en: [
            _marketExchangeTip(locale, exchangeRates: exchangeRates),
            'For CLT roles, confirm gross salary, deductions, benefits, hours, and workplace before estimating take-home pay.',
            'Keep a Portuguese CV and profile when the role requires local communication.',
            'For remote income or foreign clients, confirm eligible activity, taxes, and tax residence before choosing MEI or another structure.',
          ],
        ),
      ...
      GuideActionItem(
        ...
        whyItMatters: _t(
          locale,
          pt: 'Moradia estável facilita a rotina e a comprovação de endereço quando ela for solicitada, mas cada serviço mantém requisitos próprios.',
          es: 'Una vivienda estable facilita la rutina y el comprobante de domicilio cuando se solicite, pero cada servicio mantiene requisitos propios.',
          en: 'Stable housing supports daily life and proof of address when requested, while each service keeps its own requirements.',
        ),
        primaryActionLabel: _t(
          locale,
          pt: 'Buscar imóveis',
        ...
        requirements: _list(
          locale,
          pt: [
            'Documento e CPF quando solicitados',
            'Comprovação de renda aceita pelo responsável',
            'Uma modalidade de garantia aceita no contrato',
          ],
          es: [
            'Documento y CPF cuando se soliciten',
            'Comprobante de ingresos aceptado por el responsable',
            'Una modalidad de garantía aceptada en el contrato',
          ],
          en: [
            'ID and CPF when requested',
            'Income proof accepted by the responsible party',
            'One guarantee type accepted in the lease',
          ],
        ),
        doneCriteria: _t(
          locale,
        ...
        warningFlags: _list(
          ...
          pt: [
            ...
            'Golpe do falso anúncio: não pague antes de verificar anunciante, imóvel, condições e contrato por canais confiáveis.',
          ...
          es: [
            ...
            'Estafa del falso anuncio: no pagues antes de verificar anunciante, inmueble, condiciones y contrato por canales confiables.',
          ...
          en: [
            ...
            'Fake listing scam: do not pay before verifying the advertiser, property, conditions, and lease through trusted channels.',
