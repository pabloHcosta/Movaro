...
class MigrationReadinessSection extends StatelessWidget {
  const MigrationReadinessSection({
    required this.plan,
  ...
  Widget build(BuildContext context) {
    ...
    final checklist = MigrationReadinessBuilder.build(l10n: l10n, plan: plan);
...
class _ReadinessItemTile extends StatelessWidget {
  const _ReadinessItemTile({
    required this.item,
    required this.completed,
    required this.onToggle,
  });

  final MigrationReadinessItem item;
