...
import 'package:movaro_app/core/journey/active_journey.dart';
...
import 'package:movaro_app/core/journey/supported_country.dart';
import 'package:movaro_app/core/location/device_location_service.dart';
...
class JourneyContextController extends ChangeNotifier {
  ...
  bool canUseAsOrigin(CatalogCountry country) => country.coverage.canPlanAsOrigin;
  ...
  bool _isSupportedRoute({
    ...
    final origin = _firstWhereOrNull((country) => country.id == originCountryId);
